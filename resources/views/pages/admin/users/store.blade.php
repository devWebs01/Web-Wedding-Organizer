...
rules([
    ...
    'telp' => 'required|min:5|unique:users,telp,id',
]);
            ...
            <form wire:submit="save">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="mt-6">
                            <x-input-label for="email" :value="__('Nama Produk')" />
                        ...
                        <div class="mt-6">
                            <x-input-label for="password" :value="__('Nama Produk')" />
                        ...
                        <div class="mt-6">
                            <x-input-label for="telp" :value="__('Nama Produk')" />
