<x-modal name="add-new-products" :show="$errors->isNotEmpty()" focusable>
    <form wire:submit="save" class="p-6" enctype="multipart/form-data">
        ...
        <div class="mt-6">
            ...
            <x-text-input wire:loading.attr="disabled" wire:model="quantity" id="quantity" class="block mt-1 w-full"
                type="number" name="quantity" autofocus autocomplete="quantity" />
        ...
        <div class="mt-6">
            ...
            <x-textarea wire:loading.attr="disabled" wire:model="description" id="description" class="block mt-1 w-full"
                type="number" name="description" autofocus autocomplete="description" />
