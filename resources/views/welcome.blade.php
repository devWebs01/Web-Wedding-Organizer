        ...
        <div>
            ...
            <div class="relative items-center justify-center w-full overflow-x-hidden lg:pt-40 lg:pb-40 xl:pt-40 xl:pb-64">
                <div
                    ...
                    <div
                        ...
                        <p class="pr-0 mb-8 text-base text-gray-600 sm:text-lg xl:text-xl lg:pr-20"> Tempat terbaik untuk
                            membeli
                            pewangi laundry berkualitas tinggi!
                        </p>
                        <a href="#_"
            ...
            <div class="flex flex-col mx-3 bg-white rounded-lg">
                <div class="w-full draggable">
                    <div class="container flex flex-col items-center gap-8 mx-auto my-32">
                        <p class="text-base font-medium leading-7 text-center text-dark-grey-600">Endorsed by the premier
                            500 global corporations</p>
                        <div
                            class="flex flex-wrap items-center justify-center w-full gap-6 lg:gap-0 lg:flex-nowrap lg:justify-between">
                            <span>
                                <svg xmlns="http://www.w3.org/2000/svg" width="155" height="65" viewBox="0 0 184 65"
                                    fill="none">
                                    <path
                            ...
                            <span>
                                <svg xmlns="http://www.w3.org/2000/svg" width="184" height="49" viewBox="0 0 184 49"
                                    fill="none">
                                    <path
            ...
            <div class="container mx-auto mt-10">
                <div class="card lg:card-side bg-base-100 shadow-xl">
                    ...
                    <div class="card-body">
                        <h2 class="card-title">Keharuman Laundry Sampai Kerumahmu!</h2>
