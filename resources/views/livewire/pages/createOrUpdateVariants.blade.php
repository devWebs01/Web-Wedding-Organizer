        ...
        <div class="row">
            <div class="mb-3 col-12 col-md-6">
                ...
                <input type="text" class="form-control @error('name') is-invalid @enderror" wire:model="name"
                    id="name" aria-describedby="nameId" placeholder="Enter variant name" />
                @error('name')
                            ...
                            <td>
                                <div class="d-flex justify-content-center gap-3">
                                    ...
                                    <button wire:loading.attr='disabled'
                                        wire:click='destroyVariant({{ $item->id }})' class="btn btn-sm btn-danger"
                                        wire:confirm.prompt="Yakin ingin menghapus {{ $item->name }}?\n\nKetik 'hapus' untuk mengkonfirmasi!|hapus">
                                        Hapus
                                    </button>
