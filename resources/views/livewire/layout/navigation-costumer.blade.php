    ...
    <div class="navbar-start">
        <div class="dropdown">
            ...
            <ul tabindex="0" class="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-base-100 rounded-box w-52">
                ...
                <li>
                    <a href="/catalog/list">Katalog Produk</a>
                </li>
            </ul>
        </div>
    ...
    <div class="navbar-end">
        @auth
            <div class="flex items-center gap-3">
                <a class="btn btn-ghost btn-circle" href="/orders" role="button">
                    ...
                    <div tabindex="0" class="mt-3 z-[1] card card-compact dropdown-content w-52 bg-base-100 shadow">
                        <div class="card-body">
                            ...
                            <div class="card-actions">
                                <a href="/catalog/cart" class="btn btn-neutral btn-block">Lihat Keranjang</a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="dropdown dropdown-end">
                    ...
                    <ul tabindex="0"
                        ...
                        <li>
                            <a href="/user/{{ auth()->id() }}" class="justify-between">
                                Profil Saya
                            </a>
                        </li>
        ...
        @else
            <a href="/login" class="btn btn-outline btn-neutral mx-2">Masuk</a>
            <a href="/register" class="btn btn-neutral hover:bg-white hover:text-black mx-2">Daftar</a>
        @endauth
    </div>
</div>
