        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="url('admin/categories')" :active="request()->routeIs('admin/categories')" wire:navigate>
                        {{ __('Kategori Produk') }}
                    </x-nav-link>
                    <x-nav-link :href="url('admin/products')" :active="request()->routeIs('admin/products')" wire:navigate>
                        {{ __('Produk Toko') }}
                    </x-nav-link>
